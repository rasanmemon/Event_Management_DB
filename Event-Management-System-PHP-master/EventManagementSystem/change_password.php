<?php
	...
	if (isset($_POST['change'])) {
		...
		if (strcmp($passre, $passnew)!==0){
			...
			$read_ori = "SELECT Guest_Password FROM guest WHERE Guest_Id='$uid'";
			...
			if($result_read_ori){
				while($row = mysqli_fetch_array($result_read_ori, MYSQLI_ASSOC)){
					...
					//If same, procees with change password
						...
						$update_password = "UPDATE guest SET Guest_Password='$passre' WHERE Guest_Id='$uid'";
