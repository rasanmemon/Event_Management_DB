		...
		<form action="event_manage.php#add" method="POST">
			<table align="center" cellspacing="20px">
				...
				<tr><td>Venue: 
					<select name="a_eventvenue" >
						<?php
							 ...
							 $read_venue = "SELECT * FROM venue_details INNER JOIN event_details  ON event_details.VenueID=venue_details.VenueID";
				...
				<tr><td>Artist:<br>
					...
					if(mysqli_num_rows($result_read_venue)>0){
						while($row = mysqli_fetch_array($result_read_venue, MYSQLI_ASSOC)){
							echo "<input type='checkbox' name='' value='".$row['Artist_Name']."'>";
