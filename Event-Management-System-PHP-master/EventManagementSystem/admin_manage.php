...
//Artist
else if (isset($_POST['addartist'])) {
	header('Refresh: 0; artist_manage.php#add');
}
else if (isset($_POST['editartist'])) {
	header('Refresh: 0; artist_manage.php#edit');
}
else if (isset($_POST['deleteartist'])) {
	header('Refresh: 0; artist_manage.php#delete');
}
else if (isset($_POST['viewartist'])) {
	header('Refresh: 0; artist_manage_view.php');
}
//Sponser
else if (isset($_POST['addsponser'])) {
	header('Refresh: 0; sponser_manage.php#add');
}
else if (isset($_POST['editsponser'])) {
	header('Refresh: 0; sponser_manage.php#edit');
}
else if (isset($_POST['deletesponser'])) {
	header('Refresh: 0; sponser_manage.php#delete');
}
else if (isset($_POST['viewsponser'])) {
	header('Refresh: 0; sponser_manage_view.php');
}		
?>
...
<html>
<head>
	<title>Urban Management- Admin Management</title>
	<style type="text/css">
		a:hover{
			font-size: 24px;
		}
...
<body background="image\concrete1.jpg">
	...
	<form action="" method="POST">
		...
		<table align="center" cellspacing="20px" align="center" cellspacing="20px" style="border-bottom: 2px solid">
			<tr>
		...
		<table align="center" cellspacing="20px" align="center" cellspacing="20px" style="border-bottom: 2px solid">
			<tr>
				<td width="300px">Artist:</td>
				<td><input type="submit" name="addartist" value="Add"></td>
				<td><input type="submit" name="editartist" value="Edit"></td>
				<td><input type="submit" name="deleteartist" value="Delete"></td>
				<td><input type="submit" name="viewartist" value="View"></td>
			</tr>
		</table>
		<table align="center" cellspacing="20px">
			<tr>
				<td width="300px">Sponser:</td>
				<td><input type="submit" name="addsponser" value="Add"></td>
				<td><input type="submit" name="editsponser" value="Edit"></td>
				<td><input type="submit" name="deletesponser" value="Delete"></td>
				<td><input type="submit" name="viewsponser" value="View"></td>
			</tr>
		</table>
	</form>
